...
installing specific version of R package
```{r}
url <- "https://cran.r-project.org/src/contrib/Archive/tidyverse/tidyverse_1.3.1.tar.gz"
install.packages(url, type="source", repo=NULL)
